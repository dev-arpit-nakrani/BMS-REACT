    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-purple-100 flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 lg:p-8">
        <div className="bg-gradient-to-br from-white to-blue-50 rounded-3xl shadow-2xl p-6 lg:p-10 w-full max-w-lg border border-blue-100">
          <div className="text-center mb-8 lg:mb-10">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Create Account</h1>
            <p className="text-gray-600 mt-2 lg:mt-3 text-base lg:text-lg">Join us to manage your business</p>
          </div>
          
          <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
            <div className="relative">
              <label className="block text-sm font-semibold text-gray-700 mb-2 lg:mb-3">Full Name</label>
              <div className="relative">
            ...
            <div className="relative">
              <label className="block text-sm font-semibold text-gray-700 mb-2 lg:mb-3">Confirm Password</label>
              <div className="relative">
                <svg className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-8">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mt-6">Join Our Platform</h2>
          <p className="text-gray-600 mt-2">Start managing your business efficiently today</p>
        </div>
      </div>
    </div>
  );
